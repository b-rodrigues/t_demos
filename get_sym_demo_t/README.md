...
This demo project showcases the newly implemented `get()` and `to_symbol()` functions in T-Lang.
...
- `to_symbol(string)`: Converts a String into a Symbol, useful for dynamic name construction.
