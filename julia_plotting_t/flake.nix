{
  description = "julia_plotting_t — a T data analysis project";

  inputs = {
    nixpkgs.url = "github:rstats-on-nix/nixpkgs/2026-04-02";
    flake-utils.url = "github:numtide/flake-utils";
    t-lang.url = "github:b-rodrigues/tlang/copilot/implement-plot-support-for-julia";
  };
  ...
  outputs = { self, nixpkgs, flake-utils, t-lang }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # Julia environment
        juliaPkg = pkgs.julia-lts.withPackages [ "DataFrames" "CSV" "TidierPlots" "CairoMakie" "Plots" ];
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "=================================================="
            echo "T Project: julia_plotting_t"
            echo "=================================================="
            echo ""
