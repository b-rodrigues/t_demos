{
  description = "artifact_transfer_t — a T data analysis project";

  inputs = {
    nixpkgs.url = "github:rstats-on-nix/nixpkgs/2026-05-08";
    flake-utils.url = "github:numtide/flake-utils";
    t-lang.url = "git+file:///home/brodrigues/Documents/repos/tlang?ref=copilot/add-artifact-export-import";
  };
...
EOF
            ...
            echo "=================================================="
            echo "T Project: artifact_transfer_t"
            echo "=================================================="
            echo ""
