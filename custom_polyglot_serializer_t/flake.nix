{
  description = "custom_polyglot_serializer_t — a T data analysis project";

  inputs = {
    nixpkgs.url = "github:rstats-on-nix/nixpkgs/2026-05-10";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "=================================================="
            echo "T Project: custom_polyglot_serializer_t"
            echo "=================================================="
            echo ""
