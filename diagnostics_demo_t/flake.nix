{
  description = "diagnostics_demo_t — a T data analysis project";

  inputs = {
    nixpkgs.url = "github:rstats-on-nix/nixpkgs/2026-04-02";
    flake-utils.url = "github:numtide/flake-utils";
    t-lang.url = "github:b-rodrigues/tlang/7f32c036f749d0da77ec7605c73d4ab585871862";
  };
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "=================================================="
            echo "T Project: diagnostics_demo_t"
            echo "=================================================="
            echo ""
