{
  description = "py_uv_workspace_t — a T data analysis project";
  ...
  outputs = { self, nixpkgs, flake-utils, t-lang, pyproject-nix, uv2nix, pyproject-build-systems }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pySet = (pkgs.callPackage pyproject-nix.build.packages { python = pkgs.python314; }).overrideScope (pkgs.lib.composeManyExtensions [ pyOverlay pyproject-build-systems.overlays.default ]);
...
EOF
            ...
            echo "=================================================="
            echo "T Project: py_uv_workspace_t"
            echo "=================================================="
            echo ""
