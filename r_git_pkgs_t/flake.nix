{
  description = "r_git_pkgs_t — a T data analysis project";
        ...
        rGitPkgs = [
          (pkgs.rPackages.buildRPackage {
            ...
            buildInputs = (with pkgs.rPackages; [
              dplyr rlang stringr purrr magrittr doParallel pbapply purrrlyr assertthat data_table lubridate tidyr
            ]) ++ [ pkgs.R pkgs.gettext ];
          })
        ];
