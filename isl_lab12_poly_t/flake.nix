{
  description = "isl_lab12_poly_t — a T data analysis project";

  inputs = {
    nixpkgs.url = "github:rstats-on-nix/nixpkgs/2026-04-02";
    flake-utils.url = "github:numtide/flake-utils";
    t-lang.url = "git+file:///home/brodrigues/Documents/repos/tlang?ref=more-julia-refactor";
  };
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "=================================================="
            echo "T Project: isl_lab12_poly_t"
            echo "=================================================="
            echo ""
